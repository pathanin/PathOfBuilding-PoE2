...
return {
	...
	["Soul Core of Vizoma"] = {
		...
		["wand"] = {
				...
				statOrder = { 978 },
				tradeHashes = { [737908626] = { "30% increased Critical Hit Chance for Spells" },  },
				canSocketInUniqueItems = true,
				canSocketInJewellery = true,
				canSocketInCorruptedSanctified = true,
				levelReq = 0,
	...
	["Legacy of Chernobog's Pillar"] = {
		["shield"] = {
				...
				statOrder = { 9234 },
				tradeHashes = { [2621116283] = { "Gain 1% of damage as Fire damage per 2% Chance to Block" },  },
				bonded = {
